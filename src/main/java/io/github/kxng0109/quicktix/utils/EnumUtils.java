...
/**
 * Reflection-based utility for flexible Enum deserialization.
 * <p>
 * Standard Spring Enum conversion only matches the exact constant name. This utility
 * enhances that behavior by allowing case-insensitive matching against both the
 * exact constant name (e.g., "UPCOMING") and a human-readable display name (e.g., "Upcoming")
 * if the Enum implements a {@code getDisplayName()} method.
 * </p>
 */
