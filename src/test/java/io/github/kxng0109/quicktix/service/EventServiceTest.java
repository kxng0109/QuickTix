...
public class EventServiceTest {
	...
	public void getEventsByDateRange_should_returnListOfEventResponse_whenRequestIsValid() {
		...
		when(eventRepository.findByEventStartDateTimeBetween(any(Instant.class), any(Instant.class),
		                                                     any(Pageable.class)
		))
				.thenReturn(eventPage);
	...
	public void updateEventStatus_should_updateEventStatus() {
		...
		verify(eventRepository).findStartedEvent(any(EventStatus.class), any(Instant.class));
