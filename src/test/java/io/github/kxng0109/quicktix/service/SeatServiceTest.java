...
public class SeatServiceTest {
	...
	public void getAvailableSeats_should_throwEntityNotFoundException_whenNoEventIsFound() {
		...
		assertThrows(EntityNotFoundException.class, () -> seatService.getAvailableSeats(eventId, pageable));
	...
	public void getAllSeatsByEvent_should_returnAPageOfAvailableAllSeats_whenAllCorrect() {
		...
		when(eventRepository.findById(anyLong())).thenReturn(Optional.of(event));
		when(seatRepository.findByEventId(anyLong(), any(Pageable.class))).thenReturn(seatPage);

		Page<SeatResponse> responses = seatService.getAllSeatsByEvent(eventId, pageable);
	...
	public void getAllSeatsByEvent_should_throwEntityNotFoundException_whenNoEventIsFound() {
		...
		assertThrows(EntityNotFoundException.class, () -> seatService.getAllSeatsByEvent(eventId, pageable));
